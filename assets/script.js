...
function displayWeather(cityName) {
    var url = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=7dcb7db5b74289484d778ecc6780e688&units=imperial`;
    fetch(url)
        ...
        <li class="title">${currentData.name} : <span style="color:#046661;"> ${moment(
                        currentData.dt,
                        "X"
                    ).format(" MMM DD, YYYY")} </span></li>
        ...
        <li>${moment(fiveDayData.daily[i].dt, "X").format(" MMM DD, YYYY")}</li>
